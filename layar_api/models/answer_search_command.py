...
class AnswerSearchCommand(BaseSearchCommand):
    ...
    def __init__(self, batch_grouping_key=None, question_ids=None, question_key=None, rejected=None, show_accepted_first=None, single_doc_question_document_id=None, with_concepts=None, *args, **kwargs):  # noqa: E501
