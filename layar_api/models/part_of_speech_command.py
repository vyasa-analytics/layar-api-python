...
class PartOfSpeechCommand(object):
    ...
    def __init__(self, text=None):  # noqa: E501
        """PartOfSpeechCommand - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartOfSpeechCommand, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartOfSpeechCommand):
            return False
