...
class StatementApi(object):
    ...
    def aggregate_values(self, **kwargs):  # noqa: E501
        """Return distinct values in columns  # noqa: E501

        Get a distinct values and counts for columns of data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.aggregate_values(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.aggregate_values_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.aggregate_values_with_http_info(**kwargs)  # noqa: E501
            return data

    def aggregate_values_with_http_info(self, **kwargs):  # noqa: E501
        """Return distinct values in columns  # noqa: E501

        Get a distinct values and counts for columns of data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.aggregate_values_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method aggregate_values" % key
                )
            params[key] = val
        del params['kwargs']
