...
class SourceDocumentApi(object):
    ...
    def delete_0(self, **kwargs):  # noqa: E501
        """delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_0(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_0_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_0_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_0_with_http_info(self, **kwargs):  # noqa: E501
        """delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_0_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/sourceDocument/{id}/annotations', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_1(self, **kwargs):  # noqa: E501
        """delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_1(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_1_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_1_with_http_info(self, **kwargs):  # noqa: E501
        """delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_1_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def update_annotation_0(self, body, id, **kwargs):  # noqa: E501
        """updateAnnotations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_annotation_0(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_annotation_0_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_annotation_0_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_annotation_0_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """updateAnnotations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_annotation_0_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_annotation_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_annotation_0`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_annotation_0`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/sourceDocument/{id}/annotations/{annotationId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
