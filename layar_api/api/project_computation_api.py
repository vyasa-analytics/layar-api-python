...
class ProjectComputationApi(object):
    ...
    def download(self, id, **kwargs):  # noqa: E501
        """Download computation job document based on id and url  # noqa: E501

        Download documents for a project computation job  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def download_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/layar/projectComputation/{id}/download', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
