...
class VectorSimilarityApi(object):
    ...
    def create_vector_similarity(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_vector_similarity(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_vector_similarity_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_vector_similarity_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def create_vector_similarity_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_vector_similarity_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_vector_similarity" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_vector_similarity`")  # noqa: E501
    ...
    def get_vector_similarity(self, id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_vector_similarity_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vector_similarity_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def get_vector_similarity_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_vector_similarity" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_vector_similarity`")  # noqa: E501
    ...
    def get_vectors_by_query_string(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vectors_by_query_string(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_vectors_by_query_string_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_vectors_by_query_string_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_vectors_by_query_string_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vectors_by_query_string_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_vectors_by_query_string" % key
                )
            params[key] = val
        del params['kwargs']
