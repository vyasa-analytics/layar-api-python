...
[**layar_paragraph_get**](ParagraphApi.md#layar_paragraph_get) | **GET** /layar/paragraph | Search for paragraphs
[**parse_text**](ParagraphApi.md#parse_text) | **POST** /layar/partOfSpeech/parseText | Parse text into part-of-speech components
[**search_paragraph**](ParagraphApi.md#search_paragraph) | **POST** /layar/paragraph/search | 
...
Find paragraphs by their ID or other object parameters.
...
try:
    ...
    print("Exception when calling ParagraphApi->layar_paragraph_get: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ParagraphApi->search_paragraph: %s\n" % e)
```
